...
//                 {/* Hide Booking History & Watchlists for AGENT */}
//                 {role !== "AGENT" && (
//                   <>
...
//                 {/* Supplier Options only for roles not SUPPLIER or TENANT */}
//                 {role !== "SUPPLIER" && role !== "TENANT" && (
//                   <TabsTrigger value="supplier-options" icon={User}>
//                     My Supplier 
//                   </TabsTrigger>
//                 )}
//               </TabsList>
...
//             {role !== "SUPPLIER" && role !== "TENANT" && (
//               <TabsContent value="supplier-options" activeTab={activeTab}>
//                 <div className="bg-slate-800/50 rounded-2xl p-8 backdrop-blur-sm border border-slate-700">
//                   <ConnectedSuppliers/>
//                 </div>
//               </TabsContent>
...
//                 </div>
//                 <h2 className="text-2xl font-bold mb-1">Floyd Miles</h2>
//                 <p className="text-slate-400 text-sm">whatthaSignuIs@gmail.com</p>
//               </div>
...
//                 {/* Booking History & Watchlists for TENANT */}
//                 {role === "TENANT" && (
//                   <>
//                     <TabsTrigger value="booking-history" icon={History}>
//                       Booking History
...
//       if (role === "TENANT") setActiveTab("booking-history");
//       else if (role === "AGENT") setActiveTab("my-supplier");
//       else if (role === "SUPPLIER") setActiveTab("my-agent");
//     }
//   }, [status, session]);
